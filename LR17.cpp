...
//	}
//
//    Tree* search(Tree* item, int v) // ïîèñê ïîääåðåâà ïî ýëåìåíòó
//    {
...
//            }
//        }
//        // óäàëåíèå óçëà, êîòîðûé èìååò ëåâîãî ïîòîìêà.
//        else if (item->left != nullptr && item->right == nullptr && item->parent != nullptr)
//        {
...
//
//        }
//        // óäàëåíèå óçëà, êîòîðûé èìååò ïðàâîãî ïîòîìêà.
//        else if (item->left == nullptr && item->right != nullptr && item->parent != nullptr)
//        {
...
//
//        }
//        // óäàëåíèå óçëà, êîòîðûé èìååò îáà ïîòîìêà.
//        else if (item->left != nullptr && item->right != nullptr && item->parent != nullptr)
//        {
//            currentTree = item->right;
