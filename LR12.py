...
#current file - входные данные
#Всего их 40. Допустим, в память входит 10
#тогда возьмем первые 10 отсортируем слиянием и запишем в А
#Следующие 10 сортируем в В, Потом снова в А, затем снова в В
